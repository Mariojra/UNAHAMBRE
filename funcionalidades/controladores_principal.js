...
function banner(id, nombreRestaurante){
    ...
    axios({
        ...
        document.querySelector('#seleccion').innerHTML = `<a href="javascript:void(0);" id="a-restaurant" data-id="${datos.idRestaurante}"> ${nombreRestaurante} </a> <span>/ menu</span>`;
